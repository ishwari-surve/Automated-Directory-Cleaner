...
![Initial Execution](screenshots/initial_execution.jpeg)
...
![Scheduled Execution](screenshots/scheduled_execution.jpeg)

### Program Shutdown

The application can be safely stopped using `Ctrl+C`. The program handles `KeyboardInterrupt` and exits cleanly.

![Program Shutdown](screenshots/program_shutdown.jpeg)
